...
class Project < ApplicationRecord
  ...
  validates :demo_link, format: { with: /\Ahttps?:\/\//i, message: "must start with http:// or https://" }, allow_blank: true
  validates :repo_link, format: { with: /\Ahttps?:\/\//i, message: "must start with http:// or https://" }, allow_blank: true
